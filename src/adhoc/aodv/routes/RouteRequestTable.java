...
public class RouteRequestTable {
	...
	public boolean routeRequestEntryExists(String sourceAddress, int broadcastID){
	...
	public void setRouteRequestTimer(String sourceAddres, int broadcastID) throws NoSuchRouteException{
	 ...
	 */
	public RouteEntry getRouteRequestEntry(String sourceAddress, int broadcastID, boolean removeEntry) throws NoSuchRouteException{
		synchronized (tableLock) {
	 ...
	 */
	public boolean removeEntry(String sourceAddress, int broadcastID) {
		synchronized (tableLock) {
	...
	private class EntryKey{
		...
		public EntryKey(String sourceAddres, int broadcastID){
			this.nodeAddress = sourceAddres;
		...
		public boolean equals(Object obj) {
			...
			if(k.getNodeAddress().equals(nodeAddress) && k.getBroadcastID() == broadcastID){
				return true;
			}
			return false;
		}
		...
		@Override
		public int hashCode(){
			return (nodeAddress+";"+Integer.toString(broadcastID)).hashCode();
		}
